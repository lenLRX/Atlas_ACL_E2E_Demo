...
apt install -y cmake git libopencv-dev fonts-droid-fallback libfreetype6-dev libspdlog-dev nlohmann-json-dev python3-dev python3-sklearn python3-numpy python3-opencv python3-pip python3.7 python3.7-dev libeigen3-dev

python3.6 -m pip install -i https://pypi.tuna.tsinghua.edu.cn/simple pip --upgrade
python3.6 -m pip config set global.index-url https://pypi.tuna.tsinghua.edu.cn/simple
python3.6 -m pip install torch torchvision numpy --upgrade
